...
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (4,"Chef Anton's Cajun Seasoning",2,2,"48 - 6 oz jars",22.0000,53,0,0,0);
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (5,"Chef Anton's Gumbo Mix",2,2,"36 boxes",21.3500,0,0,0,1);
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (6,"Grandma's Boysenberry Spread",3,2,"12 - 8 oz jars",25.0000,120,0,25,0);
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (7,"Uncle Bob's Organic Dried Pears",3,7,"12 - 1 lb pkgs.",30.0000,15,0,10,0);
...
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (20,"Sir Rodney's Marmalade",8,3,"30 gift boxes",81.0000,40,0,0,0);
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (21,"Sir Rodney's Scones",8,3,"24 pkgs. x 4 pieces",10.0000,3,40,5,0);
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (22,"Gustaf's Knäckebröd",9,5,"24 - 500 g pkgs.",21.0000,104,0,25,0);
...
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (41,"Jack's New England Clam Chowder",19,8,"12 - 12 oz cans",9.6500,85,0,10,0);
...
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (45,"Røgede sild",21,8,"1k pkg.",9.5000,5,70,15,0);
...
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (61,"Sirop d'érable",29,2,"24 - 500 ml bottles",28.5000,113,0,25,0);
...
INSERT INTO `Products` (`ProductID`, `ProductName`, `SupplierID`, `CategoryID`, `QuantityPerUnit`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder`, `ReorderLevel`, `Discontinued`) VALUES (71,"Fløtemysost",15,4,"10 - 500 g pkgs.",21.5000,26,0,0,0);
