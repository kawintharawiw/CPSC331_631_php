          ...
          <li><a class="drop" href="#">Pyramid 36</a>
            <ul>
              ...
              <li><a class="drop" href="#">Pyramid 19-24</a>
                <ul>
                  <li><a href="wiw_19.php">Pyramid_PHP19</a></li>
                  <li><a href="wiw_20.php">Pyramid_PHP20</a></li>
                  <li><a href="wiw_21.php">Pyramid_PHP21</a></li>
                  <li><a href="wiw_22.php">Pyramid_PHP22</a></li>
                  <li><a href="wiw_23.php">Pyramid_PHP23</a></li>
                  <li><a href="wiw_24.php">Pyramid_PHP24</a></li>
                </ul>
              </li>
...
<div class="form">
    <h1>UPDATE</h1>
        <form name="registation" action="update.php" method="post">
...
require("db.php");
$sql="update $tb set ";
$sql.="email='". $_GET['updemail'] ."', ";
$sql.="password='". $_GET['updpassword'] ."' ";
$sql.="where id='". $_GET['updid'] ."'";
